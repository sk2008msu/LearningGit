% Loads Internals.txt, objects.txt files 
...
while(goal_flag == 0)
    ...
    if goal_flag == 1
        [temp_hits_holder, parent_hit_rays] = final_iterator(wall_array,receiver_box_edges,primary_rays,radian_tick,min_acceptable_power);
    else
