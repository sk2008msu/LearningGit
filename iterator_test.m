...
for ray_count = 150:1:226 %set to 0:1:size(rays,2) for production; for loop allows for breath iteration  75:1:80
    ray_flag = 0;
    ...
    while(ray_flag == 0) % while loop allows for depth ray iteration
       ...
       % hits
        ...
        elseif box_distance <= distance
            ...
            %%box_distance_value = box_distance
            %%box_key_index_value = box_key_index
            %%box_hits(box_key_index,1)
            %value = "Entered box <distance"
            ...
            %master_ray = [master_ray current_ray];
            %ray_flag = 1
            break;
        end
        %value = "moved past break somehow"
      %  depth_flag4 = depth_flag
        ...
        if key_index > 0
            ...
            %wall_angle2 = atan2([estart(2) eend(2)],[estart(1) eend(1)])
            % angle of reflection
            ...
            %reflect_angle_pre = reflect_angle
